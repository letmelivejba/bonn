...
<div class="container">
	...
	<a class='btn btn-primary m-b-1em' href="<?php echo base_url();?>santiago/teacher">View Teacher List</a>
      ...
      <div class="modal-body">
        <form method="POST" id="myForm">
           ...
           <label for="con" class="col-sm-4 col-form-label">CONTACT NUMBER</label>
            ...
            <input name="typ" type="hidden" value="S" class="form-control"> 
            </div>        
         </form>
      </div>
...
$(function(){
	showAllStudent()
      ...
      $('#myForm').attr('action', '<?php echo base_url() ?>santiago/addstutea');
    		});
		...
		function showAllStudent(){
			$.ajax({
				type: 'GET',
				url: '<?php echo base_url() ?>santiago/showAllStudent',
				async: false,
				dataType: 'JSON',
